...
/// </summary>
public class GetContributorHandler(IReadRepository<Person> _repository)
  : IQueryHandler<GetContributorQuery, Result<ContributorDTO>>
{
  public async Task<Result<ContributorDTO>> Handle(GetContributorQuery request, CancellationToken cancellationToken)
  {
    ...
    return new ContributorDTO(entity.Id, entity.Name, entity.PhoneNumber ?? "", entity.Gender, entity.Age, entity.Email, entity.Nationality);
  }
}
